...
Contributions:
This lab required some assistance in creating an effective program using python 3
as well as some topics i was not clear on. Kevin Apodacas and Nicholas Venecia provided
the knowledge that was needed for the lab itself
